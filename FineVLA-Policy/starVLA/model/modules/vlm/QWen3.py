...
# _ACTION_TOKEN_MIN = 151851 # how can we know this range? --> we has other way for this, but is slower see qwenhelix branch
# _ACTION_TOKEN_MAX = 153898 # here only for fast_tokenizer, see starVLA/model/modules/vlm/tools/add_qwen_special_tokens/README.md

_ACTION_TOKEN_MIN = 151669 # how can we know this range? --> we has other way for this, but is slower see qwenhelix branch
...
if __name__ == "__main__":
    ...
    cfg.framework.qwenvl.base_vlm = "/cpfs29jb/data/limingsheng.lms/vla-cpt-ckpt/qwen-4b/1119-qwen3-4b-s3-baselinesft/hf_ckpts_open/iter_0004000"
