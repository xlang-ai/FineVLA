...
export LIBERO_HOME=/root/Benchmarks/LIBERO  # Root directory of the LIBERO project
export LIBERO_python=/root/miniconda3/envs/LIBERO/bin/python  # Path to the Python environment
