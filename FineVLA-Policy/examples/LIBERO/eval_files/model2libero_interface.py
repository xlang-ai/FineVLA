...
class ModelClient:
    def __init__(
        self,
        policy_ckpt_path,
        unnorm_key: Optional[str] = "franka",
        policy_setup: str = "starVLA",
        horizon: int = 0,
    ...
    def step(
        ...
        **kwargs
        ...
        example["robot_tag"] = self.unnorm_key
        vla_input = {
            "examples": [example],
            "do_sample": False,
        ...
        if step % action_chunk_size == 0:
            ...
            normalized_actions = normalized_actions[:, :7] # only take the first 7 dimensions for action, ignore the rest if there are any
