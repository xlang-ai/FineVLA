...
run_id=qwen35_OFT_FGOnly_5w_RoboTwin_SFT_local
pretrained_checkpoint=/mnt/cpfs_m6_29eu38p1/data/shared/Group-m6/tongzai.hxt/StarVLA_YJH/results/Checkpoints/qwen35_OFT_FGOnly_5w_RoboTwin_SFT_local/checkpoints/steps_110000_pytorch_model.pt
###########################################################################################
