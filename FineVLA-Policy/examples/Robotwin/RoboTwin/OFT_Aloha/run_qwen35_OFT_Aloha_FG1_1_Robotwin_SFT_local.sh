...
echo "RUNNING: QwenOFT SFT from Aloha_OFT_FG1_1 on RoboTwin-Clean (robotwin_clean, 100k SFT steps)"
...
# Task folders live under Benchmark/RoboTwin-Clean (see mixtures.py robotwin_clean scan).
...
run_id=qwen35_OFT_Aloha_FG1_1_RoboTwin_Clean_SFT
pretrained_checkpoint=/mnt/cpfs_m6_29eu38p1/data/shared/Group-m6/tongzai.hxt/StarVLA_YJH/results/Checkpoints/OFT_ALOHA/Aloha_OFT_FG1_1/checkpoints/steps_100000_pytorch_model.pt
###########################################################################################
...
accelerate launch \
  ...
  --run_id ${run_id} \
  --wandb_project qwen35_OFT_Aloha_RoboTwin_SFT \
