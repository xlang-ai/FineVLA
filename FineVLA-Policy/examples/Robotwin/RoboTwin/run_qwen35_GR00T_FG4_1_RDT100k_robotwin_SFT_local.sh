...
echo "RUNNING: QwenGR00T SFT RESUME from step 100k on RoboTwin-Clean (100k→200k)"
...
run_id=qwen35_GR00T_FG4_1_RDT100k_RoboTwin_SFT
pretrained_checkpoint=${PROJECT_ROOT}/results/Checkpoints/qwen35_GR00T_FG4_1_RDT100k_RoboTwin_SFT/checkpoints/steps_100000_pytorch_model.pt
###########################################################################################
...
accelerate launch \
  ...
  --trainer.scheduler_total_steps 100000 \
