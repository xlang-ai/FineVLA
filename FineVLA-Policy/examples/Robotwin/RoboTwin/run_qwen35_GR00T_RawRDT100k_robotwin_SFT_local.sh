...
echo "RUNNING: QwenGR00T SFT from RDT-100k checkpoint on RoboTwin-Clean (200k steps)"
...
run_id=qwen35_GR00T_RDT100k_RoboTwin_SFT
pretrained_checkpoint=/mnt/cpfs_m6_29eu38p1/data/shared/Group-m6/tongzai.hxt/StarVLA_YJH/results/Checkpoints/qwen35_GR00T_RDT_dlc/checkpoints/steps_100000_pytorch_model.pt
###########################################################################################
