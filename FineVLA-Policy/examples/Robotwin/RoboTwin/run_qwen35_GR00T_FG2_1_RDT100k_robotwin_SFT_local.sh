...
echo "RUNNING: QwenGR00T SFT from FG2_1_RDT-100k checkpoint on RoboTwin-Clean (100k SFT steps)"
...
data_root=/mnt/cpfs_m6_29eu38p1/data/shared/Group-m6/tongzai.hxt/VLA_Data/Raw_Datasets/RoboTwin-Randomized/Clean
data_mix=robotwin_clean
run_root_dir="${PROJECT_ROOT}/results/Checkpoints"
run_id=qwen35_GR00T_FG2_1_RDT100k_RoboTwin_SFT
pretrained_checkpoint=/mnt/cpfs_m6_29eu38p1/data/shared/Group-m6/tongzai.hxt/StarVLA_YJH/results/Checkpoints/qwen35_GR00T_FG2_1_RDT_dlc/checkpoints/steps_100000_pytorch_model.pt
###########################################################################################
...
accelerate launch \
  ...
  --run_id ${run_id} \
  --wandb_project qwen35_GR00T_RoboTwin_SFT \
