...
run_id=0410_${Framework_name}_${data_mix}_3d5_4B
# === End of environment variable configuration ===
###########################################################################################

# /mnt/cpfs_m6_29e5gphu/data/user/jinhui/Projects/starVLA/examples/MultiRobot/train_files/starvla_cotrain_multiRobot_exp3.yaml
