...
echo "RUNNING: QwenGR00T SFT from RawAloha on RoboTwinMix (Clean+Randomized, 100k SFT steps)"
...
pretrained_checkpoint=/mnt/cpfs_m6_29eu38p1/data/shared/Group-m6/tongzai.hxt/StarVLA_YJH/results/Checkpoints/RawAloha/checkpoints/steps_200000_pytorch_model.pt
###########################################################################################
