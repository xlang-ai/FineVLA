...
echo "RUNNING: QwenGR00T SFT from RDT_FGOnly on RoboTwinMix (Clean+Randomized, 100k SFT steps)"
...
run_id=qwen35_GR00T_RDT_FGOnly_RoboTwinMix_SFT
...
accelerate launch \
  ...
  --run_id ${run_id} \
  --wandb_project qwen35_GR00T_RoboTwinMix_SFT \
