...
echo "RUNNING: QwenGR00T SFT from RDT_FG4_1 on RoboTwinMix (Clean+Randomized, 100k SFT steps)"
...
run_id=qwen35_GR00T_RDT_FG4_1_RoboTwinMix_SFT
pretrained_checkpoint=/mnt/cpfs_m6_29eu38p1/data/shared/Group-m6/tongzai.hxt/StarVLA_YJH/results/Checkpoints/qwen35_GR00T_FG4_1_RDT_dlc/checkpoints/steps_100000_pytorch_model.pt
###########################################################################################
