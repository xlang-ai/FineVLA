...
echo "RUNNING: QwenOFT SFT from Aloha_OFT_FGOnly on RoboTwinMix (Clean+Randomized, 100k SFT steps)"
...
run_id=qwen35_OFT_Aloha_FGOnly_RoboTwinMix_SFT
pretrained_checkpoint=/mnt/cpfs_m6_29eu38p1/data/shared/Group-m6/tongzai.hxt/StarVLA_YJH/results/Checkpoints/OFT_ALOHA/Aloha_OFT_FGOnly/checkpoints/steps_100000_pytorch_model.pt
###########################################################################################
...
accelerate launch \
  ...
  --run_id ${run_id} \
  --wandb_project qwen35_OFT_Aloha_RoboTwinMix_SFT \
