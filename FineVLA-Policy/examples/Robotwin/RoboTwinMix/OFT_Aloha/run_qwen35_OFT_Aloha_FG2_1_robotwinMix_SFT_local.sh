...
echo "RUNNING: QwenOFT SFT from Aloha_OFT_FG2_1 on RoboTwinMix (Clean+Randomized, 100k SFT steps)"
...
run_id=qwen35_OFT_Aloha_FG2_1_RoboTwinMix_SFT
pretrained_checkpoint=/mnt/cpfs_m6_29eu38p1/data/shared/Group-m6/tongzai.hxt/StarVLA_YJH/results/Checkpoints/OFT_ALOHA/Aloha_OFT_FG2_1/checkpoints/steps_100000_pytorch_model.pt
###########################################################################################
