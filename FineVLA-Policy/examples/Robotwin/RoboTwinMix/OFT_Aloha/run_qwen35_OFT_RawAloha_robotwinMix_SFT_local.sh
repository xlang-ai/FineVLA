...
echo "RUNNING: QwenOFT SFT from RawAloha_OFT on RoboTwinMix (Clean+Randomized, 100k SFT steps)"
...
run_id=qwen35_OFT_RawAloha_RoboTwinMix_SFT
pretrained_checkpoint=/mnt/cpfs_m6_29eu38p1/data/shared/Group-m6/tongzai.hxt/StarVLA_YJH/results/Checkpoints/OFT_ALOHA/RawAloha_OFT/checkpoints/steps_100000_pytorch_model.pt
###########################################################################################
