...
echo "RUNNING: QwenOFT SFT from RawRDT-5w on RoboTwinMix (Clean+Randomized, 200k SFT steps)"
...
run_id=qwen35_OFT_RawRDT5w_RoboTwinMix_SFT
pretrained_checkpoint=/mnt/cpfs_m6_29eu38p1/data/shared/Group-m6/tongzai.hxt/Qwen-StarVLA/results/Checkpoints/xintonghu_qwen3.5_OFT_RawRDT_dlc/checkpoints/steps_50000_pytorch_model.pt
###########################################################################################
