...
echo "RUNNING: QwenGR00T + Qwen3.5-4B on RDT-yhq FGOnly (ALOHA)"
...
data_mix=rdt_yhq_FGOnly
run_root_dir="${PROJECT_ROOT}/results/Checkpoints"
run_id=qwen35_GR00T_FGOnly_RDT_dlc
pretrained_checkpoint="${PROJECT_ROOT}/results/Checkpoints/qwen35_GR00T_FGOnly_RDT_dlc/checkpoints/steps_70000_pytorch_model.pt"
###########################################################################################
