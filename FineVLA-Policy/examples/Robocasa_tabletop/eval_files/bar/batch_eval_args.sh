...
starVLA_PYTHON=/root/miniconda3/envs/starVLA/bin/python
ROBOCASA_PYTHON=/root/miniconda3/envs/robocasa/bin/python
export PYTHONPATH=$(pwd):${PYTHONPATH}

CKPT_DEFAULT="/mnt/cpfs_m6_29e5gphu/data/user/jinhui/Projects/starVLA/results/Checkpoints/0219_QwenGR00TN1d6_epx3_multi_robot_exp3_2B/checkpoints/steps_110000_pytorch_model.pt"
N_ENVS_DEFAULT=1
...
# Check if simulation_env.py processes are still running
