...
export sim_python=/root/miniconda3/envs/SimplerEnv/bin/python
export SimplerEnv_PATH=/root/Benchmarks/SimplerEnv
...
if [ -z "$MODEL_PATH" ]; then
  ...
  export MODEL_PATH="/mnt/cpfs_m6_29e5gphu/data/user/jinhui/Projects/starVLA/results/Checkpoints/0219_QwenGR00TN1d6_epx3_multi_robot_exp3_2B/checkpoints/steps_150000_pytorch_model.pt"
fi
