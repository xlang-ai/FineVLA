...
class ModelClient:
    ...
    def step(
        ...
        normalized_actions = normalized_actions[:, :7] # chunk, 7 (x, y, z, roll, pitch, yaw, open_gripper)
    ...
    def get_action_stats(unnorm_key: str, policy_ckpt_path) -> dict:
        ...
        # unnorm_key = baseframework._check_unnorm_key(norm_stats, unnorm_key) # This is actually environment-specific
