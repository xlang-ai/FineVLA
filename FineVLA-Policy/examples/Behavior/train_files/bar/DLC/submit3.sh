...
freeze_module_list=''
base_vlm=/cpfs29jb/data/limingsheng.lms/vla-cpt-ckpt/qwen-4b/1128-qwen3-4b-s3-basline_so100_gsft5/iter_0003244
...
run_id=1225_${QwenGR00T}_${data_mix}_1128-qwen3-4b-s3-basline_so100_gsft5
