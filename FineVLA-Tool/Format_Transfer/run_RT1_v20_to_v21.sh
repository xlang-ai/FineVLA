#!/bin/bash
# =============================================================================
# RT-1 dataset: LeRobot v2.0 → v2.1 conversion runner
# =============================================================================
...
# 提高单进程可打开文件数，避免 "Too many open files"（87k+ episodes 会检查大量路径）
ulimit -n 1048576 2>/dev/null || true

# --- Config ---
# 输入: v2.0 数据集路径（原地转换后可选移动到 TARGET_ROOT）
DATASET_ROOT="/mnt/cpfs_m6_29eu38p1/data/shared/Group-m6/tongzai.hxt/VLA_Data/Lerobot_v20/RT-1"
